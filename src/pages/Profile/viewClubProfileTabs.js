...
import ClubEventsTab from "./ViewClubEventsTab.js";

function TabPanel(props) {
  const { children, value, index, club, ...other } = props;
...
const ViewClubProfileTabs = ({ club }) => {
  ...
  return (
    <div className={classes.root}>
      ...
      <TabPanel club={club} value={value} index={0}></TabPanel>
      <TabPanel value={value} index={1}>
        <ClubEventsTab club={club} />
      </TabPanel>
      <TabPanel club={club} value={value} index={2}>
        Saved Posts
      </TabPanel>
    </div>
  );
...
export default ViewClubProfileTabs;
